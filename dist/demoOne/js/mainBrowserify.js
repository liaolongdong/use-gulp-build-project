...
if(!noGlobal){window.jQuery=window.$=jQuery;}return jQuery;});},{}],2:[function(require,module,exports){(function(global){/**
 * @license
...
root._=_;}}).call(this);}).call(this,typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{});},{}],3:[function(require,module,exports){'use strict';Object.defineProperty(exports,"__esModule",{value:true});// module.exports = function () {
//     const div = document.createElement('section');
//     div.innerHTML = 'this is demoOne aboutjs insert content!';
//     document.body.appendChild(div);
//     console.log('this is demoOne about.js');
//     console.log('this is demoOne about.js');
// }
function about(){var div=document.createElement('section');div.innerHTML='this is demoOne aboutjs insert content!';document.body.appendChild(div);console.log('this is demoOne about.js');console.log('this is demoOne about.js');console.log('this is demoOne about.js');}exports.default=about;},{}],4:[function(require,module,exports){'use strict';var _jquery=require('jquery');var _jquery2=_interopRequireDefault(_jquery);var _lodash=require('lodash');var _lodash2=_interopRequireDefault(_lodash);var _orderBrowserify=require('./orderBrowserify');var _orderBrowserify2=_interopRequireDefault(_orderBrowserify);var _aboutBrowserify=require('./aboutBrowserify');var _aboutBrowserify2=_interopRequireDefault(_aboutBrowserify);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}(function(win,doc){// // 使用requie引入第三方库
// jQuery = require('jquery');
// lodash = require('lodash');
console.log('jquery',(0,_jquery2.default)('.footer'));console.log('lodash',_lodash2.default.isEmpty([1,2,3]));// const order = require('./order.js');
// const about = require('./about.js');
(0,_orderBrowserify2.default)();(0,_aboutBrowserify2.default)();console.log('this is demoOne order and about node was insert body node successful!');console.log('this is demoOne order and about node was insert body node successful!');console.log('this is demoOne order and about node was insert body node successful!');})(window,document);},{"./aboutBrowserify":3,"./orderBrowserify":5,"jquery":1,"lodash":2}],5:[function(require,module,exports){'use strict';Object.defineProperty(exports,"__esModule",{value:true});// module.exports = function () {
//     const div = document.createElement('section');
//     div.innerHTML = 'this is demoOne orderjs insert content!';
//     document.body.appendChild(div);
//     console.log('this is demoOne order.js');
// }
function order(){var div=document.createElement('section');div.innerHTML='this is demoOne orderjs insert content!';document.body.appendChild(div);console.log('this is demoOne order.js');}exports.default=order;},{}]},{},[4]);